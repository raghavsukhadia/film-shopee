...
export default function AboutPageClient() {
  return (
    <div style={{ padding: '2rem', backgroundColor: '#fefbf3', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '1.5rem', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            ...
            <span style={{ padding: '0.375rem 0.75rem', backgroundColor: 'rgba(245,158,11,0.3)', color: 'white', border: '1px solid rgba(245,158,11,0.5)', borderRadius: '9999px', fontSize: '0.75rem', fontWeight: 700, backdropFilter: 'blur(10px)' }}>Cloud Powered</span>
          </div>
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: '1.25rem', marginTop: '1rem', maxWidth: '800px', lineHeight: '1.6', fontWeight: 400 }}>
            Zoravo OMS is the all-in-one Operations Management System developed by Filmshoppee that automates your workflow, 
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', flexWrap: 'wrap' }}>
            <a href="mailto:info@filmshoppee.com" style={{ textDecoration: 'none' }}>
              <button style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ marginTop: '1.5rem' }}>
          <Label>About Filmshoppee</Label>
          <Value>
            Filmshoppee – The Car Facelift Studio is passionate about providing safe and affordable car facelift solutions. 
            We give your car a facelift providing flawless minor model update makeovers without disturbing the core of the automobile. 
            Our professional team helps you choose the best parts available based on your specific requirements.
          </Value>
        </div>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          ...
          <Value>
            Zoravo OMS was developed by Filmshoppee to revolutionize how automotive service businesses operate. 
...
function TestimonialCard({ quote, author, role }: { quote: string; author: string; role: string }) {
  return (
    <div style={{ 
      ...
      <div style={{ fontSize: '1.5rem', color: '#f59e0b', marginBottom: '0.75rem' }}>"</div>
