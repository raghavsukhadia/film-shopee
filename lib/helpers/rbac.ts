...
export const ROUTE_PERMISSIONS: Record<string, UserRole[]> = {
  ...
  // Vehicles - managers and coordinators (accountants and installers removed)
  '/vehicles': ['admin', 'manager', 'coordinator'],
  '/vehicles/[id]': ['admin', 'manager', 'coordinator'],
...
export function getNavigationItems(userRole: UserRole) {
  const items = [
    ...
    },
    {
      ...
      href: '/vehicles',
      icon: 'Truck',
      roles: ['admin', 'manager', 'coordinator'] // Accountant and Installer should NOT have Vehicle Management
    },
    {
      title: 'Trackers',
      href: '/trackers',
