...
export default function SubscriptionGuard({ children }: SubscriptionGuardProps) {
  ...
  const checkSubscriptionStatus = async () => {
    try {
      ...
      // Check if current user is admin - but admins should still be blocked when tenant is inactive
      // They can only access Settings to submit payment proof
  ...
  // IMPORTANT: Even admins should be blocked when tenant is inactive - they can only access Settings
  const shouldBlock = 
    subscriptionStatus !== null &&
    !subscriptionStatus.isActive && 
    !isAllowedPage
    // Note: isAdmin is NOT used here - admins are also blocked when tenant is inactive
